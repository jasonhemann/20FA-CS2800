...
## PollEverywhere
  ...
  7. Make sure you can log in to your Northeastern (via your `@northeastern.edu` address) [PollEverywhere account and verify your phone number](https://web.archive.org/web/20191228185219/https://web.northeastern.edu/nle/poll-everywhere-resources/#menu-item-359:~:text=faculty%2Fstaff-,Students,Verifying%20your%20phone%20number%20if%20you%E2%80%99re%20using%20text%20messages) if you answer PollEverywhere questions via text. 
